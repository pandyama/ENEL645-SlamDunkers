...
model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate = 1e-8),loss='categorical_crossentropy',metrics=['accuracy'])


history_ft = model.fit(train_generator, epochs=50, verbose = 1, callbacks= [early_stop, monitor_ft, lr_schedule],validation_data = (validation_generator))
