...
# Defining callbacks
model_name_it = "/home/makissin/TL-garbage-classification/Outputs/garbage_classifier_en_b0_100_epochs_wo_imagenet_it.h5"
model_name_ft = "/home/makissin/TL-garbage-classification/Outputs/garbage_classifier_en_b0_10_epochs_wo_imagenet_ft.h5"
...
it_file = open("it_history_100_epochs_wo_imagenet.pkl", "wb")
...
ft_file = open("ft_history_100_epochs_wo_imagenet.pkl", "wb")
...
plt.show()
plt.savefig('Accuracy_IT_100_epochs_wo_imagenet.png')
plt.plot(loss_it, label='Training Loss')
plt.plot(val_loss_it, label='Validation Loss')
plt.legend(loc='upper right')
plt.title('Training and Validation Loss')
plt.show()
plt.savefig('Loss_IT_100_epochs_wo_imagenet.png')
...
plt.title('Training and Validation Accuracy')
plt.show()
plt.savefig('Accuracy_FT_100_epochs_wo_imagenet.png')
plt.plot(loss_ft, label='Training Loss')
plt.plot(val_loss_ft, label='Validation Loss')
plt.legend(loc='upper right')
plt.title('Training and Validation Loss')
plt.show()
plt.savefig('Loss_FT_100_epochs_wo_imagenet.png')