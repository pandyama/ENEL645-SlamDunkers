...
# plt.savefig("Outputs/traindistribution.png")
...
# plt.savefig("Outputs/valdistribution.png")
...
# plt.savefig("Outputs/testdistribution.png")



# Defining callbacks

model_name_it = "/home/gregory.slowski/645-FinalProject/TL_100_Dropout/Outputs/garbage_classifier_RN_TL_100_dropout20_it.h5"
model_name_ft = "/home/gregory.slowski/645-FinalProject/TL_100_Dropout/Outputs/garbage_classifier_RN_TL_100_dropout20_ft.h5"
...
x2 = keras.layers.Dropout(0.2)(x1)  # Regularize with dropout
x3 = tf.keras.layers.Flatten()(x2)

out = tf.keras.layers.Dense(len(class_names),activation = 'softmax')(x3)
...
history_it = model.fit(train_generator, epochs=100, verbose = 1,callbacks= [early_stop, monitor_it, lr_schedule],\
                       validation_data = (validation_generator))


# Saving the traning history
it_file = open("/home/gregory.slowski/645-FinalProject/TL_100_Dropout/Outputs/RN_TL_100_dropout20_it_history.pkl", "wb")
...
ft_file = open("/home/gregory.slowski/645-FinalProject/TL_100_Dropout/Outputs/RN_TL_100_dropout20_ft_history.pkl", "wb")
