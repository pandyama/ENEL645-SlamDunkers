...
model_name_it = "/home/brandon.quan/Outputs/garbage_classifier_inception_v3_it.h5"
model_name_ft = "/home/brandon.quan/Outputs/garbage_classifier_inception_v3_ft.h5"
...
history_it = model.fit(train_generator, epochs=1000, verbose = 1,callbacks= [early_stop, monitor_it, lr_schedule],\
...
history_ft = model.fit(train_generator, epochs=1000, verbose = 1, \
