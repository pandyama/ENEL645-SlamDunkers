...
model_name_it = "/home/zachary.frena/TL-garbage-classification/Outputs/garbage_classifier_vgg16_withoutImagenet_it.h5"
model_name_ft = "/home/zachary.frena/TL-garbage-classification/Outputs/garbage_classifier_vgg16_withoutImagenet_ft.h5"
...
base_model = tf.keras.applications.VGG16(
    include_top=True, # for non-imagenet weights, set to true
    weights=None, # weights would be None
    input_shape=(img_height, img_width, 3), 
    pooling=None,
    classes=1000
)

base_model.trainable=True # for non-imagenet weigts, set to true


x1 = base_model(base_model.input, training=True) # for non-imagenet weigts, set to true
...
history_it = model.fit(train_data_set, epochs=10, verbose=1, callbacks=[early_stop, monitor_it, lr_schedule],
                       validation_data=(test_data_set))


# Savint the training history
it_file = open(
    "/home/zachary.frena/TL-garbage-classification/Outputs/it_history_vgg16_withoutImagenet.pkl", "wb")
...
ft_file = open(
    "/home/zachary.frena/TL-garbage-classification/Outputs/ft_history_vgg16_withoutImagenet.pkl", "wb")
